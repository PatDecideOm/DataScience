...
dataset = pd.read_csv('C:/applis/kaggle/tabular-playground-series-jun-2021/train.csv')
unseen = pd.read_csv('C:/applis/kaggle/tabular-playground-series-jun-2021/test.csv')
