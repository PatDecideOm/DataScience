...
dataset = pd.read_csv('c:/applis/kaggle/tabular-playground-series-mar-2021/train.csv')
unseen = pd.read_csv('c:/applis/kaggle/tabular-playground-series-mar-2021/test.csv')
